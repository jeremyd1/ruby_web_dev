...
class LineAnalyzer
  ...
  def calculate_word_frequency()
      ...
      @highest_wf_words = @word_count.keys.select {|k| @word_count[k] == @highest_wf_count}
  end
end
...
class Solution
  ...
  def calculate_line_with_highest_frequency()
      @highest_count_across_lines = @analyzers.max_by {|x| x.highest_wf_count}.highest_wf_count
